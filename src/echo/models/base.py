...
class Port(BaseModel):
    ...
    slack: bool = False
    objective: en.numeric_expr.NumericExpression | int = 0  # this will eventually be a pyomo expression
...
class Node(BaseModel):
    ...
    uid: str = Field(default_factory=shortuuid.uuid)
    ports: dict[str, Port] = {}
    objective: en.numeric_expr.NumericExpression | int = 0  # For adding any node objectives
