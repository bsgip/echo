...
*echo* uses `pyomo <https://pyomo.readthedocs.io/en/stable/index.html>`_ module to solve optimisation problems and thus needs at least one solver package installed.
