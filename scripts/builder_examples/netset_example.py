...
from echo.echo_builder import Network, NetworkSet
...
print("\n")
print(
    "Time to optimise all sites for {} intervals of {} minutes was {} minutes".format(
        time_periods, interval_duration, np.round((t2 - t1) / 60)
    )
)
