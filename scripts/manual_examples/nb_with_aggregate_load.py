...
cws = [
    ...
    PathTariff(component=load_to_grid, tariff_array=(remote_energy_tariff - remote_transport_export) * -1),
    PathTariff(component=load_to_bess, tariff_array=(local_energy_tariff - local_transport_export) * -1),
]

# Cost for storage operator
cstorage = [
    PathTariff(component=load_to_bess, tariff_array=local_energy_tariff + local_transport_import),
...
rnetwork = [
    ...
    PathTariff(component=load_to_bess, tariff_array=local_transport_import),
    PathTariff(component=load_to_grid, tariff_array=remote_transport_export),
    ...
    PathTariff(component=load_to_bess, tariff_array=local_transport_export),
]
