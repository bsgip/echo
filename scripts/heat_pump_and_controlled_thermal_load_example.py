...
plt.plot(elec_in, label='HP elec_in (kW)')
plt.plot(heat_out, label='HP heating out (kW)')
plt.plot(cool_out, label='HP cooling out (kW)')
# plt.plot(hload, label='heat load')
# plt.plot(cload, label='cool load')
plt.plot(temp, label='load internal temp (degC)')
plt.legend()
plt.show()
